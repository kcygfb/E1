...
namespace KiKs.Combat.Tests
{
    public sealed class DemoFlowStateTests
    {
        ...
        [Test]
        public void BattlesAdvanceInDogGirlEyeOrderWithinOneDayAndThenComplete()
        {
            Assert.That(DemoFlowState.CurrentStage, Is.EqualTo(DemoStage.DogBattle));
            Assert.That(DemoFlowState.CurrentExplorationNumber, Is.EqualTo(1));
            ...
            Assert.That(DemoFlowState.CurrentExplorationNumber, Is.EqualTo(2));
            ...
            Assert.That(DemoFlowState.CurrentExplorationNumber, Is.EqualTo(3));
